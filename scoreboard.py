...
class Scoreboard():
    '''a class that keeps scores'''

    def __init__(self, ai_settings, screen, stats):
        '''initialise score settings'''
        self.screen = screen
        self.screen_rect = screen.get_rect()
        self.ai_settings = ai_settings
        self.stats = stats

        #set the font of scores
        self.text_colour = (30, 30, 30)
        self.font = pygame.font.SysFont(None, 48)

        #prepare score image and record image
        self.prep_score()
